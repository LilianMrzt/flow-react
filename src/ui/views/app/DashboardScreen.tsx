...
import NoActiveProjectsSection from '@ui/blocs/views/app/dashboard-screen/NoActiveProjectsSection'
import SubTitle from '@components/text/SubTitle'
import Column from '@components/layout/Column'
import './dashboard-screen.css'
import DashboardCard from '@ui/blocs/views/app/dashboard-screen/DashboardCard'
...
import ActiveProjectsSection from '@ui/blocs/views/app/dashboard-screen/ActiveProjectsSection'
