...
import BackTableCell from '@ui/blocs/views/app/project-details/project-details-backlog-screen/backlog-table/BackTableCell'
...
import BacklogTaskDropdown from '@ui/blocs/views/app/project-details/project-details-backlog-screen/BacklogTaskDropdown'
import MenuWrapper from '@components/dropdowns/menu/MenuWrapper'
import { BacklogTaskProps } from '@interfaces/ui/blocs/views/app/project-details/project-details-backlog-screen/backlog-table/BacklogTaskProps'
